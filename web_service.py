...
available_requests = ['SiteList', 'MeasurementList', 'GetData', 'RecentDataTable', 'DataTable']
...
def build_url(base_url, hts, request, collection=None, site=None, measurement=None, from_date=None, to_date=None, location=None, site_parameters=None, agg_method=None, agg_interval=None, alignment=None, quality_codes=False, tstype=None):
    """
...
def get_recent_datatable(base_url, hts, collection, from_date=None, to_date=None):
    """
    Function to query a Hilltop web server for time series data associated with a collection.
    ...
    """
    ### Make url
    url = build_url(base_url=base_url, hts=hts, request='RecentDataTable', collection='River Level', from_date=from_date, to_date=to_date)
...
def get_datatable(base_url, hts, collection, from_date=None, to_date=None):
    """
    Function to query a Hilltop web server for time series data associated with a collection.
    ...
    """
    ### Make url
    url = build_url(base_url=base_url, hts=hts, request='DataTable', collection='River Level', from_date=from_date, to_date=to_date)
